...
namespace SEIIApp.Server {
    public class Startup {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, Services.QuizService quizService, Services.FeedbackService feedbackService, Services.CourseService courseService)
        {
            ...
            TestDataInitializer.InitializeFeedbackTestData(feedbackService);
#endif
